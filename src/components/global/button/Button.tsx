...
const Button: React.FC<ButtonDataType> = ({
  ...
  const variants = {
    ...
    red: 'group justify-center p-0.5 font-medium relative focus:z-10 border border-transparent enabled:hover:bg-[#e44332] dark:enabled:hover:bg-[#e44332] inline-flex items-center px-2 py-1 text-sm font-small text-center text-white bg-[#e44332] rounded-lg hover:bg-[#e44332] focus:ring-4 focus:outline-none focus:ring-[#e44332] dark:bg-[#e44332] dark:hover:bg-[#e44332] dark:focus:ring-[#e44332',
  };
